...
const TokenList = ({
  ...
  return (
    <div className="w-full h-screen absolute top-0 left-0 z-20 flex items-center justify-center backdrop-blur-sm">
      <div
        ref={wrapperRef}
        className="w-full max-w-[414px] bg-[#14151A] flex flex-col gap-3 p-5 rounded-[18px]"
      >
        ...
        <input
          type="text"
          className="border-[rgba(255,255,255,0.1)] border-[1px] bg-[#191A20] px-3 py-4 rounded-md outline-none"
