        ...
        <div className="w-full flex justify-between items-center py-[120px]">
          <div className="w-[610px] flex flex-col">
            ...
            <div className="flex gap-6 h-10 items-center">
              <div className="w-10 h-10 flex justify-center items-center border-[1px] rounded-full border-[rgba(255,255,255,0.1)]">
                <div className="w-1.5 h-1.5 bg-[rgba(255,255,255,0.1)] rounded-full" />
              </div>
              <p className="text-sm font-normal leading-7">
                Seller of STX has to put STX into escrow.
              </p>
            </div>
            <div className="w-[1px] h-[56px] ml-5 bg-[rgba(255,255,255,0.1)]" />
            <div className="flex gap-6 h-10">
              <div className="flex-none w-10 h-10 flex justify-center items-center border-[1px] rounded-full border-[rgba(255,255,255,0.1)]">
            ...
            <div className="w-[1px] h-[56px] ml-5 bg-[rgba(255,255,255,0.1)]" />
            <div className="flex gap-6 h-10">
              <div className="flex-none w-10 h-10 flex justify-center items-center border-[1px] rounded-full bg-[#191A20] border-[rgba(255,255,255,0.1)]">
                <div className="w-1.5 h-1.5 bg-white rounded-full" />
              </div>
              <p className="text-sm font-normal leading-7">
